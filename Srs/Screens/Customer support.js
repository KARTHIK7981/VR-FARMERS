...
import { View, Text, Image, StyleSheet, TouchableOpacity, StatusBar, SafeAreaView, navigation, TextInput, Linking } from 'react-native';
        ...
        <><StatusBar
            ...
            <SafeAreaView style={[styles.container]}>
             ...
             <View style={styles.v2}>
                   ...
                   <LottieView style={styles.img2} source={require('../Images/85835-call-center-support.json')} autoPlay loop  />
             </View>
             <View style={styles.v3}>
                    ...
                    <View style={styles.v3_2}>
                       <View style={styles.v3_2_1} >
                            <Text style={styles.t3} onPress={()=>{Linking.openURL('tel:9182017247');} }>+91 9182017247</Text>
                        </View>
                    ...
                    <View style={styles.v3_3}>
                        ...
                        <View style={styles.v3_4}>
                            <Text style={styles.t6} onPress={()=>{Linking.openURL('mailto:vraquafarmers@gmail.com?subject=SendMail&body=Description: ');} }>vraquafarmers@gmail.com</Text>
                      </View>
              </View>
             <View style={styles.v4}>
                                           <Button 
                                            // variant="extended"
                                            title="Logout" 
                                            onPress={() => navigation.navigate('Croptype')}  style={styles.btn2} ></Button>
