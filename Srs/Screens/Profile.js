        ...
        <><StatusBar
            ...
            <View style={styles.v1}>
                    <View style={styles.v1_1}>
                        ...
                        <LottieView style={styles.img1} source={require('../Images/122222-profile-avatar-for-child.json')} autoPlay loop  />
                    </View>
            ...
            <View style={styles.v2}>
                    ...
                    <TouchableOpacity style={styles.v2_1}  onPress={() => navigation.navigate('Customer support')}>
                    ...
                    <TouchableOpacity style={styles.v2_2}  onPress={() => navigation.navigate('Terms & conditions')}>
                    ...
                    <TouchableOpacity style={styles.v2_3}  onPress={() => navigation.navigate('Privacy Policy')}>
            ...
            <View style={styles.v3}>
                                           <Button 
                                            // variant="extended"
                                            title="Logout" 
                                            onPress={() => navigation.navigate('Login')}  style={styles.btn2} ></Button>
